    ...
    public class ToolBar : Control
    {
        ...
        public Size ButtonSize
        {
            get
            {
                if (buttonSize.IsEmpty)
                {
                    ...
                    {
                        int result = (int)PInvoke.SendMessage(this, PInvoke.TB_GETBUTTONSIZE, 0, 0);
                        if (result > 0)
                        {
        ...
        protected override CreateParams CreateParams
        {
            get
            {
                ...
                cp.ClassName = ComCtl32.WindowClasses.WC_TOOLBAR;

                // windows forms has it's own docking code.
                //
                cp.Style |= PInvoke.CCS_NOPARENTALIGN
                            | PInvoke.CCS_NORESIZE;
        ...
        internal int PreferredHeight
        {
            get
            {
                ...
                {
                    height *= unchecked((int)PInvoke.SendMessage(this, PInvoke.TB_GETROWS, 0, 0));
                }
        ...
        internal void InternalSetButton(int index, ToolBarButton value, bool recreate, bool updateText)
        {
            ...
            if (IsHandleCreated)
            {
                ...
                PInvoke.SendMessage(this, PInvoke.TB_SETBUTTONINFO, (WPARAM)index, ref tbbi);
                ...
                else
                {
                    ...
                    //
                    PInvoke.SendMessage(this, PInvoke.TB_AUTOSIZE, 0, 0);
        ...
        protected override void OnHandleCreated(EventArgs e)
        {
            ...
            //
            PInvoke.SendMessage(this, PInvoke.TB_BUTTONSTRUCTSIZE, (WPARAM)Marshal.SizeOf<NativeMethods.TBBUTTON>(), 0);
        ...
        {
            PInvoke.SendMessage(this, PInvoke.TB_SETBUTTONSIZE, 0, NativeMethods.Util.MAKELPARAM((int)(buttonSize.Width * currentScaleDX), (int)(buttonSize.Height * currentScaleDY)));
        }
        ...
        {
            PInvoke.SendMessage(this, PInvoke.TB_SETTOOLTIPS, toolTip.HWND, 0);
        ...
        {
            var lParam = m.GetLParam(typeof(NativeMethods.NMTOOLBAR)) ?? throw new InvalidOperationException("lparam of a received message should not be null");

            NativeMethods.NMTOOLBAR nmTB = (NativeMethods.NMTOOLBAR)lParam;
            ...
            if (menu != null)
            {
                ...
                PInvoke.SendMessage(this, PInvoke.TB_GETRECT, (WPARAM)nmTB.iItem, ref rc);
                ...
                else
                {
                    ...
                    PInvoke.MapWindowPoints((HWND)nmTB.hdr.hwndFrom, HWND.Null, ref rc);
        ...
        {
            var lParam = m.GetLParam(typeof(NMTBHOTITEM)) ?? throw new InvalidOperationException("lparam of a received message should not be null");

            // Should we set the hot item?
            NMTBHOTITEM nmTbHotItem = (NMTBHOTITEM)lParam;
