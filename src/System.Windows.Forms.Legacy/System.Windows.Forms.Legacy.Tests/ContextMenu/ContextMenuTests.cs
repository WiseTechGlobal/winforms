...
public class ContextMenuTests
{
    ...
    public static IEnumerable<object[]> Ctor_MenuItemArray_TestData()
    {
        ...
        yield return new object[] { new MenuItem[] { new() }, true };
    }
    ...
    [StaTheory]
    [CommonMemberData(typeof(CommonTestHelper), nameof(CommonTestHelper.GetRightToLeftTheoryData))]
    ...
    {
        using (var menu = new ContextMenu(new MenuItem[] { new("text") }))
        {
    ...
    public static IEnumerable<object[]> ProcessCmdKey_TestData()
    {
        ...
        yield return new object[] { new MenuItem("text", new MenuItem[] { new() }) { Shortcut = Shortcut.CtrlA }, true, 0, 1 };
        yield return new object[] { new MenuItem("text", new MenuItem[] { new() }) { Shortcut = Shortcut.CtrlA, Enabled = false }, false, 0, 0 };
    }
