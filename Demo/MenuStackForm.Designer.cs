...
partial class MenuStackForm
{
    ...
    private void InitializeComponent()
    {
        ...
        _summaryLabel.Text = "Phase 1 menu stack demo combining the legacy MainMenu, MenuItem, ContextMenu, toolbar drop-down menus, dynamic popups, owner-draw items, and TreeNode.ContextMenu samples used across this demo project.";
        // 
        ...
        _surfaceMessageLabel.Text = "Right-click this surface or the TreeView nodes to exercise ContextMenu and TreeNode.ContextMenu support, or use the MainMenu and toolbar entries above to trigger menu actions.";
