...
public partial class WebBrowser
{
    ...
    private class WebBrowserEvent : StandardOleMarshalObject, SHDocVw.DWebBrowserEvents2
    {
        ...
        public void BeforeNavigate2(
            ...
            ref bool cancel)
        {
            Debug.Assert(Parent is not null, "Parent should have been set");
        ...
        public unsafe void DocumentComplete(object pDisp, ref object? urlObject)
        {
            ...
            if (Parent._documentStreamToSetOnLoad is not null && (string?)urlObject == "about:blank")
            {
                ...
                if (htmlDocument is not null)
                {
                    ...
                    using var pStream = ComHelpers.GetComScope<IStream>(new Ole32.GPStream(Parent._documentStreamToSetOnLoad));
                    psi.Load(pStream);
