    ...
    public class StatusBar : Control
    {
        ...
        private void ApplyPanelWidths()
        {
            ...
            if (length == 0)
            {
                ...
                SendMessage(NativeMethods.SB_SETICON, 0, (int)IntPtr.Zero);
        ...
        protected override void CreateHandle()
        {
            if (!RecreatingHandle)
            {
                IntPtr userCookie = UnsafeNativeMethodsCore.ThemingScope.Activate();
                ...
                {
                    UnsafeNativeMethodsCore.ThemingScope.Deactivate(userCookie);
                }
            }
        ...
        ///  full controls.
        /// </summary>
        private class ControlToolTip : IHandle<HWND>
        {
            public class Tool
            {
            ...
            private void AddTool(Tool tool)
            {
                if (tool != null && tool.text != null && tool.text.Length > 0)
                {
                    ...
                    if (info.SendMessage(p.ToolTipSet ? (IHandle<HWND>)p.mainToolTip : this, WindowMessages.TTM_ADDTOOLW) == IntPtr.Zero)
                    {
            ...
            protected void CreateHandle()
            {
                ...
                User32.SendMessageW(this, (User32.WM)WindowMessages.TTM_SETMAXTIPWIDTH, IntPtr.Zero, (IntPtr)SystemInformation.MaxWindowTrackSize.Width);
            }
            ...
            private ComCtl32.ToolInfoWrapper<Control> GetTOOLINFO(Tool tool)
            {
                ...
                ti.Info.uFlags |= (TOOLTIP_FLAGS)(ComCtl32.TTF.TRANSPARENT | ComCtl32.TTF.SUBCLASS);

                // RightToLeft reading order
                Control richParent = parent;
                if (richParent != null && richParent.RightToLeft == RightToLeft.Yes)
                {
                    ti.Info.uFlags |= (TOOLTIP_FLAGS)ComCtl32.TTF.RTLREADING;
                }
